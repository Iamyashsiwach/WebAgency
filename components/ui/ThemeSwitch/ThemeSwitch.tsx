...
// // Update GlobalStyle to use ThemeProps instead of string
// const GlobalStyle = createGlobalStyle<{ theme: ThemeProps }>`
//   body {
//     background-color: ${({ theme }) => (theme.mode === "dark" ? "#1d1f2c" : "#f3fdff")};
...
//   // State to manage the theme, defaulting to "light" if no theme is stored in localStorage
...
//   // Create a theme object that matches our ThemeProps interface
